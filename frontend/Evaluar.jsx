...
export default function Evaluar() {
  ...
  async function cargarMiEval() {
    ...
    try {
      ...
      if (data) {
        ...
        setComentarios(prev => ({ ...prev, [arb.id]: data.comentario || '' }))
  ...
  function setComentario(valor) {
    setComentarios(prev => ({ ...prev, [arb.id]: valor }))
  }
    ...
    <div className="screen">
      ...
      <div className="app-body">
        ...
        <div className="card" style={{marginBottom:12}}>
          <div style={{fontSize:12,fontWeight:500,color:'var(--gray)',textTransform:'uppercase',letterSpacing:'.8px',marginBottom:8}}>
            Comentarios del evaluador <span style={{fontWeight:400,color:'var(--gray2)'}}>(opcional)</span>
          </div>
          <textarea
            value={arbComentario}
            ...
            style={{
              ...
              borderRadius:8, fontSize:13, fontFamily:'var(--font)', color:'var(--dark)',
              outline:'none', resize:'vertical', lineHeight:1.5, transition:'border .2s'
            }}
