...
import { Input, PasswordInput, Field } from '../components/forms'
    ...
    <div className="login-screen">
      <div className="login-box animate-fade">
        ...
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 24, color: 'white', letterSpacing: '3px' }}>
            {config.fedNombre}
          </h1>
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div style={{ marginBottom: 14 }}>
            ...
            <input
              ...
              style={{
                ...
                borderRadius: 10, color: 'white', fontSize: 14, fontFamily: 'var(--font)',
          ...
          <button
            ...
            disabled={loading}
            style={{
              width: '100%', padding: '12px', background: loading ? 'var(--red-dark)' : 'var(--red)',
